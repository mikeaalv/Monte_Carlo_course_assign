//this program will use metropolis importance sampling to study LXL Ising model
...
// run:
// ./metropois L T N randseeds inip gap
// Argument:
...
int main(int argc, char* argv[])
{
  ...
  long Nsamp=stol(argv[3]);
  long rseed=stol(argv[4]);
  double inip=stod(argv[5]);
  long gap=stod(argv[6]);
